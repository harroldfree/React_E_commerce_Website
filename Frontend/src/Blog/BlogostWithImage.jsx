...
export default function BlogostWithImage() {
    ...
    <Center py={6} className='d-flex justify-content-around'>
      <Box
        ...
        <Box h={'180px'} bg={'gray.100'} mt={-6} mx={-6} mb={6} pos={'relative'}>
          <img src="../src/assets/images/blog/12.jpg" className='cc' alt="" />
        </Box>
        <Stack>
          <Text
            color={'green.500'}
      ...
      <Box
        ...
        overflow={'hidden'}>
        <Box h={'180px'} bg={'gray.100'} mt={-6} mx={-6} mb={6} pos={'relative'}>
          <img src="../src/assets/images/blog/06.jpg" className='cc' alt="" />
        </Box>
        <Stack>
          <Text
            color={'green.500'}
      ...
      <Box
        ...
        overflow={'hidden'}>
        <Box h={'180px'} bg={'gray.100'} mt={-6} mx={-6} mb={6} pos={'relative'}>
          <img src="../src/assets/images/blog/11.jpg" className='cc' alt="" />
        </Box>
        <Stack>
          <Text
            color={'green.500'}
